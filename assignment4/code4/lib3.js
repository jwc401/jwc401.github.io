...
function gl_update(gl) {
   ...
   gl.uniform4fv(uVar('uSphere'), spheres); 
   gl.uniform3fv(uVar('uAmbient'), ambients);
   gl.uniform3fv(uVar('uDiffuse'), diffuses);
   gl.uniform3fv(uVar('uSpecular'), speculars);
   gl.uniform1fv(uVar('uPower'), powers);
